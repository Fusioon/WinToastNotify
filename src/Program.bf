...
struct __x_ABI_CWindows_CData_CXml_CDom_CIXmlDocument
{
	...
	public struct Vtbl : ComExGenericVtbl<SelfOuter>
	{
		...
		public function HResult (ThisT* This, IInspectable* namespaceUri,    HSTRING qualifiedName,    __x_ABI_CWindows_CData_CXml_CDom_CIXmlAttribute** newAttribute) CreateAttributeNS;
		public function HResult (ThisT* This, IInspectable* namespaceUri,    HSTRING qualifiedName,    __x_ABI_CWindows_CData_CXml_CDom_CIXmlElement** newElement) CreateElementNS;
...
""";
	...
	[CLink, CallingConvention(.Stdcall)]
	static extern HResult RoActivateInstance(HSTRING activatableClassId, IInspectable** instance);
